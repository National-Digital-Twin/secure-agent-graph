...
public class MainSecureAgentGraph {

    public final static Logger LOG = LoggerFactory.getLogger("uk.gov.dbt.ndtp.SAgentGraph");
    ...
    OTEL_SERVICE_NAME to give the application a human-readable name e.g. Secure Agent Graph
