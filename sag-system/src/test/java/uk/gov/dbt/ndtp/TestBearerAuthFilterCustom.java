...
class TestBearerAuthFilterCustom extends AbstractBearerAuthTests {
    ...
    static void setUpClass() throws Exception {
        ...
        LibTestsSAG.DEFAULT_AUTH_HEADER = CUSTOM_AUTH_HEADER;
        LibTestsSAG.DEFAULT_AUTH_PREFIX = "Test";
        Properties properties = LibTestsSAG.getAuthConfigurationProperties(false);
